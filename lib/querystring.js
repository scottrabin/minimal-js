...
define(function(require, exports) {
	...
	exports.stringify = function(queryKey, prefix) {
		...
		for (var key in queryKey) {
			...
			value = queryKey[key];
			if (is.array(value)) {
				// if value contains any objects, or if value is a sparse array,
				// include the array index in the querystring
				if (value.every(is.object) || (Object.keys(value).length !== value.length)) {
