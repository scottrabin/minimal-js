...
define(function(require) {
	...
	function constructClass() {
		...
		ConstructedClass.mix.apply(ConstructedClass, Array.prototype.reduce.call(arguments, function(current, mixin) {
			return current.concat(mixin._mixins ? mixin._mixins : mixin);
		}, []));
