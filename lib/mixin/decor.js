...
define(function(require) {
	...
	return {
		...
		wrap: function(methodName, decorator) {
			//>>includeStart("ministryStrict", pragmas.ministryStrict);
			if (typeof this[methodName] !== 'function') {
				throw new TypeError("Cannot define a `wrap` decorated function with non-function method name");
			}
			//>>includeEnd("ministryStrict");
			this[methodName] = decor.wrap(this[methodName], decorator);
		},
