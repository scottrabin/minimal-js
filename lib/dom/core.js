...
define(function(require) {
	...
	function DomCore(prototype, Constructor) {
		...
		/**
		 * Resolve a variable to a single element
		 *
		 * @param {DOM.Core|HTMLElement} element
		 * @return {HTMLElement}
		 */
		Constructor.toElement = function(element) {
		...
		prototype.after('initialize', function(selector, context) {
			...
			if (!selector) {
				...
				// array or array-like given; import the elements
